...
from src.search_methods.greedy_word_swap_wir_random import GreedyWordSwapWIR_RANDOM
...
class RandomBaseline(AttackRecipe):
    ...
    def build(
        ...
        # Search method
        search_method = GreedyWordSwapWIR_RANDOM(wir_method="random", greedy_search=greedy_search)
